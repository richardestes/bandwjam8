...
namespace TarodevGhost {
    public class ReplaySystem {
        ...
        public bool FinishRun(bool save = true) {
            ...
            // If no current best exists or if last run was faster than previous best,
            // update best to last run
        ...
        // Plays back the replay point by point
